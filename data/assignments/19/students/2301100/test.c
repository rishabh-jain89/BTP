...
int main() {
    ...
    printf("After setting position %d to %d:", set_pos, set_value);
    list = seti(list, set_pos + 1, set_value);
    printlist(list);

    int add_pos, add_value;
    scanf("%d %d", &add_pos, &add_value);
    printf("After adding %d at position %d:", add_value, add_pos);
    list = addi(list, add_pos + 1, add_value);
    printlist(list);

    int remove_pos;
    scanf("%d", &remove_pos);
    printf("After removing position %d:", remove_pos);
    list = remi(list, remove_pos + 1);
    printlist(list);

    int key, key_value;
    scanf("%d %d", &key, &key_value);
    printf("After adding %d after key %d:", key_value, key);
    list = addkey(list, key, key_value);
    printlist(list);

    int remove_key_value;
    scanf("%d", &remove_key_value);
    printf("After removing key %d:", remove_key_value);
    list = remkey(list, remove_key_value);
    printlist(list);
    ...
    printf("After sorted insertion of %d:", insert_value);
    sorted_list = insersort(sorted_list, insert_value);
    printlist(sorted_list);
